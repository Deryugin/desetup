...
terminal = "termite" or "xfce4-terminal"
...
mytextclock = wibox.widget.textclock("%a %b %d, %k:%M:%S", 1)
...
kbdcfg.switch = function ()
  ...
  -- os.execute( "setxkbmap us,ru -model pc104 -variant alt-int" )
  os.execute( kbdcfg.cmd .. " " .. t[1] .. ",us -model pc104 -variant alt-int" )
end
...
globalkeys = gears.table.join(
    -- Resize pane
    awful.key({ modkey, "Mod1"    }, "#46",     function () awful.tag.incmwfact( 0.01)    end),
    awful.key({ modkey, "Mod1"    }, "#43",     function () awful.tag.incmwfact(-0.01)    end),
    awful.key({ modkey, "Mod1"    }, "#44",     function () awful.client.incwfact( 0.01)    end),
    awful.key({ modkey, "Mod1"    }, "#45",     function () awful.client.incwfact(-0.01)    end),
    ...
    awful.key({ modkey, "Shift"   }, "#43",     function () awful.tag.incnmaster( 1, nil, true) end,
              {description = "increase the number of master clients", group = "layout"}),
    awful.key({ modkey, "Shift"   }, "#46",     function () awful.tag.incnmaster(-1, nil, true) end,
              {description = "decrease the number of master clients", group = "layout"}),
    awful.key({ modkey, "Control" }, "#43",     function () awful.tag.incncol( 1, nil, true)    end,
              {description = "increase the number of columns", group = "layout"}),
    awful.key({ modkey, "Control" }, "#46",     function () awful.tag.incncol(-1, nil, true)    end,
...
clientkeys = gears.table.join(
    ...
    awful.key({ modkey, "Control" }, "#58",
        function (c)
            c.maximized_vertical = not c.maximized_vertical
            c:raise()
        end ,
        {description = "(un)maximize vertically", group = "client"}),
    awful.key({ modkey, "Shift"   }, "#58",
        function (c)
